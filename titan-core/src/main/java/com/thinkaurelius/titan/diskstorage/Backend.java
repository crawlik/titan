...
public class Backend {
    ...
    protected final KeyColumnValueStoreManager storeManager;
    protected final StoreFeatures storeFeatures;

    protected KeyColumnValueStore edgeStore;
    protected KeyColumnValueStore vertexIndexStore;
    protected KeyColumnValueStore edgeIndexStore;
    private IDAuthority idAuthority;

    protected final Map<String, IndexProvider> indexes;
    ...
    protected final int writeAttempts;
    protected final int readAttempts;
    protected final int persistAttemptWaittime;
