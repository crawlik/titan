 ...
 */
public class TitanMockAccumuloStoreManager extends AccumuloStoreManager {
    ...
    public TitanMockAccumuloStoreManager(Configuration config) throws StorageException {
        super(config);
    }
}
